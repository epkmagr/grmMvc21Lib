...
INSERT INTO `services` (`title`, `image`, `price`, `description`, `filter`) VALUES
    ...
    ('Planteringar', 'services/plant.jpg', 399, 'Planteringar av krukor, rabatter och häckar. Kostnad för plantor och jord tillkommer.',"markdown"),
    ...
    ('Trädgårdskötsel', 'services/generic.jpg', 399, 'Allmän trädgårdsskötsel kan vara vattning, vårstädning, fixa gräsmattan etc.',"markdown")
;
...
-- Extra setup for the student server to make the date columns nullable.

USE mbfs17;

-- users
ALTER TABLE users MODIFY COLUMN active DATETIME NULL;
UPDATE users SET active = NULL WHERE active = '0000-00-00 00:00:00';

-- services
ALTER TABLE services MODIFY COLUMN `deleted` DATETIME NULL;
UPDATE services SET `deleted` = NULL WHERE `deleted` = '0000-00-00 00:00:00';

-- garden
ALTER TABLE garden MODIFY COLUMN `deleted` DATETIME NULL;
UPDATE garden SET `deleted` = NULL WHERE `deleted` = '0000-00-00 00:00:00';
